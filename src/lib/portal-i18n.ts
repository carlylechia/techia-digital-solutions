...
const en = {
  ...
  invoices: {
    ...
    pageDescription: "Your payment plans, invoice history, and balance overview.",
    summaryTotalInvoiced: "Contract value",
    summaryPaid: "Paid",
    ...
    markAsPaidNote: "Clicking this confirms you have transferred the payment. teChia will verify and confirm.",
    markingPaid: "Submitting…",
    markPaidSuccess: "Payment claim submitted! teChia will confirm shortly.",
    linkedPayment: "Payment plan",
    noPaymentPlan: "Not linked to a payment plan",
    proofOptional: "Attach proof of payment (optional)",
    proofRequired: "Proof of payment required",
    proofRequiredNote: "teChia raised a query on your last payment claim. Please attach proof of payment (screenshot or PDF) before resubmitting.",
    proofPlaceholder: "Click to select a file, or drag and drop",
    proofFileTypes: "JPG, PNG, WebP, PDF, DOC — max 20 MB",
    proofUploaded: "Proof attached",
  ...
  payments: {
    ...
    empty: "No payment plans",
    emptyNote: "Payment plans set up by teChia will appear here.",
    ...
    invoices: (n: number) => `${n} invoice${n !== 1 ? "s" : ""}`,
    noInvoices: "No invoices yet for this plan.",
    status: {
      ACTIVE: "Active",
      COMPLETED: "Fully paid",
      CANCELLED: "Cancelled",
...
const fr = {
  ...
  invoices: {
    ...
    pageDescription:
      "Vos plans de paiement, historique des factures et aperçu du solde.",
    summaryTotalInvoiced: "Valeur contrat",
    summaryPaid: "Payé",
    ...
    markAsPaidNote: "Cliquer ici confirme que vous avez effectué le virement. teChia vérifiera et confirmera.",
    markingPaid: "Envoi…",
    markPaidSuccess: "Demande de paiement envoyée ! teChia confirmera sous peu.",
    linkedPayment: "Plan de paiement",
    noPaymentPlan: "Non lié à un plan de paiement",
    proofOptional: "Joindre une preuve de paiement (optionnel)",
    proofRequired: "Preuve de paiement requise",
    proofRequiredNote: "teChia a soulevé une question sur votre dernière demande de paiement. Veuillez joindre une preuve de paiement (capture d'écran ou PDF) avant de soumettre à nouveau.",
    proofPlaceholder: "Cliquez pour sélectionner un fichier, ou glisser-déposer",
    proofFileTypes: "JPG, PNG, WebP, PDF, DOC — max 20 Mo",
    proofUploaded: "Preuve jointe",
  ...
  payments: {
    pageTitle: "Plans de paiement",
    sectionTitle: "Plans de paiement",
    empty: "Aucun plan de paiement",
    emptyNote: "Les plans de paiement configurés par teChia apparaîtront ici.",
    totalAgreed: "Montant total convenu",
    initialDeposit: "Acompte initial",
    paidToDate: "Payé à ce jour",
    remaining: "Restant",
    progress: "Progression du paiement",
    completed: "Entièrement réglé",
    active: "Actif",
    cancelled: "Annulé",
    linkedProjects: "Projets liés",
    invoices: (n: number) => `${n} facture${n !== 1 ? "s" : ""}`,
    noInvoices: "Aucune facture pour ce plan.",
    status: {
      ACTIVE: "Actif",
      COMPLETED: "Entièrement réglé",
      CANCELLED: "Annulé",
