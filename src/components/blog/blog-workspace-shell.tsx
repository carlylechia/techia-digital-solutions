...
import { canUseGeneralAdmin, type BlogSessionUser } from "@/lib/blog/auth";
...
export function BlogWorkspaceShell({
  ...
  const canAccessOperations = canUseGeneralAdmin(user);
  const isBlogOnly = mode === "admin" && !canAccessOperations;
